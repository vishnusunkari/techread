...
metaDescription: "How to deploy maximum number of pods on kubernetes nodes ?
---
...
Because of the above CNI limitation EKS always restricts the max pods to just 110 for m5.4xlarge node. Seems like newer versions of eksctl 
have a configuration param for maxPodsPerNode - [https://eksctl.io/usage/eks-managed-nodes/](https://eksctl.io/usage/eks-managed-nodes/) (search page for maxPodsPerNode ).
