...
After you have created the above 3, Expect to get error
```
Error: CloudHsmInvalidRequestException. Cluster already contains an HSM but has not yet been fully activated. 
```
